...
public class calendar extends AppCompatActivity implements EasyPermissions.PermissionCallbacks{
...
//    private void calendartest2() {
//        intent.setClass(this, calendartest2.class);
//        startActivity(intent);
//    }
    ...
    private void getResultsFromApi() {
        if (! isGooglePlayServicesAvailable()) {
            ...
            new calendar.MakeRequestTask(mCredential).execute();
        }
    }
